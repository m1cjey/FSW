...
tetgen_config::tetgen_config()
{
	...
	//‰Q“d—¬‰πΝ—pΘΥƒ‚ƒfƒ‹‚Μ΅–@
	
	height_conduct=0;		//•½”Β‚‚³
	length_conduct=0.1;		//•½”Β‚Μκ•Σ‚Μ’·‚³
	thickness_conduct=0.01;		//“±‘Μ‚Μϊ‚έ
	...
	fine_conduct_xy=0.01;
	fine_conduct_z=0.0005;
	layer_conduct=0.0001;			//•\”η•ª„‚Μ‘wϊ‚έ          0.01
